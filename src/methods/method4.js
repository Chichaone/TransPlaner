...
const method4 = {
  ...
  name: '4. Маятниковый маршрут с разной загрузкой по направлениям (γ₁ ≠ γ₂)',
  description:
    'Методика рассчитывает маятниковый маршрут с различными коэффициентами использования грузоподъёмности по направлениям.',
  inputs: [
  ...
  calculate: (values) => {
    ...
    const totalServiceTime = serviceTime * (tripsForward + tripsReturn);
