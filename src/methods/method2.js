...
const method2 = {
  ...
  name: '2. Маятниковый маршрут с обратным гружёным пробегом не на всём расстоянии (γ₁ = γ₂)',
  description:
    'Методика учитывает гружёные плечи и холостой участок на обратном пути при расчёте сменных показателей.',
  inputs: [
